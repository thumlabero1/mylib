...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="main-wrapper">
        ...
        <li>
        <a href="#" class="mobile-logo d-md-block d-lg-none d-block"><img src="{{ asset('assets/img/logo1.png') }}" alt="" width="30" height="30"></a>
        </li>
        </ul>
        ...
        <div class="media">
        <span class="avatar">
        <img alt="John Doe" src="{{ asset('assets/img/user-06.jpg') }}" class="img-fluid rounded-circle">
        </span>
        ...
        <span class="user-img"><img class="rounded-circle" src="{{ asset('assets/img/user-06.jpg') }}" width="30" alt="Admin">
        ...
        <li class="active">
        <a href="#"><img src="{{ asset('assets/img/sidebar/icon-1.png') }}" alt="icon"><span>Dashboard</span></a>
        </li>
        <li class="submenu">
        <a href="#"><img src="{{ asset('assets/img/sidebar/icon-2.png') }}" alt="icon"> <span> Teachers</span> <span class="menu-arrow"></span></a>
        ...
        <li class="submenu">
        <a href="#"><img src="{{ asset('assets/img/sidebar/icon-3.png') }}" alt="icon"> <span> Students</span> <span class="menu-arrow"></span></a>
        <ul class="list-unstyled" style="display: none;">
        ...
        <li class="submenu">
        <a href="#"><img src="{{ asset('assets/img/sidebar/icon-4.png') }}" alt="icon"> <span> Parents</span> <span class="menu-arrow"></span></a>
        <ul class="list-unstyled" style="display: none;">
        ...
        <li class="submenu">
        <a href="javascript:void(0);"><img src="{{ asset('assets/img/sidebar/icon-5.png') }}" alt="icon"> <span>Apps</span> <span class="menu-arrow"></span></a>
        ...
        <li>
        <a href="inbox.html"><img src="{{ asset('assets/img/sidebar/icon-6.png') }}" alt="icon"> <span>Calendar</span></a>
        </li>
        <li>
        <a href="inbox.html"><img src="{{ asset('assets/img/sidebar/icon-7.png') }}" alt="icon"> <span>Exam list</span></a>
        </li>
        <li>
        <a href="inbox.html"><img src="{{ asset('assets/img/sidebar/icon-8.png') }}" alt="icon"> <span>Holidays</span></a>
        </li>
        <li>
        <a href="inbox.html"><img src="{{ asset('assets/img/sidebar/icon-9.png') }}" alt="icon"><span> Events</span></a>
        </li>
        <li class="submenu">
        ...
        <li class="submenu">
        <a href="#"><img src="{{ asset('assets/img/sidebar/icon-11.png') }}" alt="icon"><span> Payroll </span> <span class="menu-arrow"></span></a>
        <ul class="list-unstyled" style="display: none;">
        ...
        <li class="submenu">
        <a href="#"><img src="{{ asset('assets/img/sidebar/icon-12.png') }}" alt="icon"> <span> Blog</span> <span class="menu-arrow"></span></a>
        <ul class="list-unstyled" style="display: none;">
        ...
        <li>
        <a href="inbox.html"><img src="{{ asset('assets/img/sidebar/icon-14.png') }}" alt="icon"> <span>Settings</span></a>
        </li>
        <li class="menu-title">UI Elements</li>
        <li class="submenu">
        <a href="#"><img src="{{ asset('assets/img/sidebar/icon-15.png') }}" alt="icon"> <span> Components</span> <span class="menu-arrow"></span></a>
        <ul class="list-unstyled" style="display: none;">
        ...
        <li class="submenu">
        <a href="#"><img src="{{ asset('assets/img/sidebar/icon-26.png') }}" alt="icon"> <span> Elements</span> <span class="menu-arrow"></span></a>
        <ul class="list-unstyled" style="display: none;">
        ...
        <span class="float-left"><img src="{{ asset('assets/img/dash/dash-1.png') }}" alt="" width="80"></span>
        ...
        <span class="float-right"><img src="{{ asset('assets/img/dash/dash-2.png') }}" width="80" alt=""></span>
        </div>
        </div>
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
        <div class="dash-widget dash-widget5">
        <span class="float-left"><img src="{{ asset('assets/img/dash/dash-3.png') }}" alt="" width="80"></span>
        <div class="dash-widget-info text-right">
        <span>Parents</span>
        <h3>20,000</h3>
        </div>
        ...
        <span class="float-right"><img src="{{ asset('assets/img/dash/dash-4.png') }}" alt="" width="80"></span>
        </div>
        </div>
        </div>
        <div class="row">
        ...
        <div class=" mt-sm-0 mt-2">
        <button class="btn btn-outline-primary mr-2"><img src="{{ asset('assets/img/excel.png') }}" alt=""><span class="ml-2">Excel</span></button>
        <button class="btn btn-outline-danger mr-2"><img src="{{ asset('assets/img/pdf.png') }}" alt="" height="18"><span class="ml-2">PDF</span></button>
        <button class="btn btn-light" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-ellipsis-h"></i></button>
        <div class="dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" href="#">Action</a>
        <div role="separator" class="dropdown-divider"></div>
        ...
        <tr>
        <td>
        <h2><a href="#" class="avatar text-white"><img src="{{ asset('assets/img/profile/img-1.jpg') }}" alt=""></a><a href="#">Parker <span></span></a></h2>
        </td>
        <td>ST-0d001</td>
        <td>1</td>
        <td>A</td>
        ...
        <tr>
        <td>
        <h2><a href="#" class="avatar text-white"><img src="{{ asset('assets/img/profile/img-2.jpg') }}" alt=""></a><a href="#">Smith <span></span></a></h2>
        </td>
        <td>ST-0d002</td>
        <td>2</td>
        <td>B</td>
        ...
        <tr>
        <td>
        <h2><a href="#" class="avatar text-white"><img src="{{ asset('assets/img/profile/img-3.jpg') }}" alt=""></a><a href="#">Hensley<span></span></a></h2>
        </td>
        <td>ST-0d003</td>
        <td>1</td>
        <td>A</td>
        ...
        <tr>
        <td>
        <h2><a href="#" class="avatar text-white"><img src="{{ asset('assets/img/profile/img-4.jpg') }}" alt=""></a><a href="#">Friesen<span></span></a></h2>
        </td>
        <td>ST-0d004</td>
        <td>1</td>
        <td>A</td>
        ...
        <tr>
        <td>
        <h2><a href="#" class="avatar text-white"><img src="{{ asset('assets/img/profile/img-5.jpg') }}" alt=""></a><a href="#">Jackson<span></span></a></h2>
        </td>
        <td>ST-0d005</td>
        <td>1</td>
        <td>A</td>
        ...
        <tr>
        <td>
        <h2><a href="#" class="avatar text-white"><img src="{{ asset('assets/img/profile/img-6.jpg') }}" alt=""></a><a href="#">Mason<span></span></a></h2>
        </td>
        <td>ST-0d006</td>
        <td>1</td>
        <td>A</td>
        ...
        <tr>
        <td>
        <h2><a href="#" class="avatar text-white"><img src="{{ asset('assets/img/profile/img-7.jpg') }}" alt=""></a><a href="#">Garrett <span></span></a></h2>
        </td>
        <td>ST-0d007</td>
        <td>1</td>
        <td>A</td>
        ...
        <tr>
        <td>
        <h2><a href="#" class="avatar text-white"><img src="{{ asset('assets/img/profile/img-7.jpg') }}" alt=""></a>
