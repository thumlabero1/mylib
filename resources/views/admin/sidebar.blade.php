...
<div class="sidebar">
     ...
     <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="https://avatars.githubusercontent.com/u/66507256?s=400&u=8e614ab546bcf416268495eb7b7deb559750a970&v=4" class="img-circle elevation-2" alt="User Image">        </div>
        <div class="info">
          <a href="#" class="d-block">Alexander Linh</a>
        </div>
      </div>
             ...
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                 ...
                 <li class="nav-item">
                     ...
                     <ul class="nav nav-treeview">
                         ...
                         <li class="nav-item">
                             <a href="/admin/Salary/list" class="nav-link">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Bảng lương</p>
                             </a>
                         </li>
